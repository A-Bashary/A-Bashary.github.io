...
<!-- Mirrored from www.doubledouble.ca/menu-chicken.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 May 2017 02:37:50 GMT -->
<head>
		<meta charset="utf-8" />
	...
	<body>
		...
		<div class="container_16">
			...
			<div class="grid_16 homeContent">
				...
				<!-- Content Box -->
				<div class="mainContentBox boxShadow topRadius btmRadius">
					<h3 class="topRadius flushLeft">Chicken</h3>
					
					<div class="boxContent" style="padding-bottom: 0px;">
						<div class="grid_6">
							<!-- <span class="note red">Choose: Baked or Fried</span> -->
							
							<ul class="pricingTable">
								<li>4 Pieces with Wedges	<span>9.99</span></li>
								<li>6 Pieces with Wedges	<span>12.99</span></li>
								<li>9 Pieces with Wedges	<span>17.99</span></li>
								<li>12 Pieces with Wedges	<span>23.99</span></li>
								<li>18 Pieces with Family Wedges	<span>31.99</span></li>
							</ul>
							
							<span class="note">
								Each additional piece $1.99<br>
								Extra white meat 99&#162; per piece
							</span>
							
							<ul class="pricingTable">
								<li>4 Piece Chicken Fingers	<span>5.99</span></li>
								<li>6 Piece Chicken Fingers	<span>6.99</span></li>
							</ul>
						</div>
						
						<div class="grid_8">
							<img src="assets/menu/chicken_bucket.png" alt="chicken_bucket" width="534" height="433" style="position: relative; z-index: 1; margin-top: -70px; margin-left: -15px;" />
						</div>
						<div class="clear"></div>
					</div>
...
<!-- Mirrored from www.doubledouble.ca/menu-chicken.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 May 2017 02:38:10 GMT -->
</html>
